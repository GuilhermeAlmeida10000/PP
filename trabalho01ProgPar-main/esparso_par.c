...
int n,					  // Número de elementos do vetor de entrada
	...
	indiceUltimoElemento, // Posição do último elemento diferente de 0
...
{
	// paralelização irá gerar condição de corrida na variavel m e indiceUltimoElemento
	m = 0;
	indiceUltimoElemento = n;
...
void compacta_vetor()
{
	// paralelização irá gerar condição de corrida na variavel j
	// parallel for atomic
	int j = 0;
